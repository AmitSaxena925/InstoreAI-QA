...
public class DataProviderUtil {
    ...
    public static synchronized Object[][] excelDataProvider(Method testMethod) throws IOException {
    ...
    public static synchronized Object[][] excelDataProviderTranspose(Method testMethod) throws IOException {
