...
public class ReadExcelTableUtil {
    ...
    public synchronized String[][] getTableData(String fileName, String sheetName, String tableName) throws IOException{
        String filePath =ExecutionConfig.TEST_DATA_PATH +
    ...
    private String getFinalString(String inputString) throws IOException{
