...
public class LoggerUtils
{
	 ...
	 */
	public static void initializeLogFolder(String className) {
	...
	/**
	 * sets the file path to store the logs, i.e., "logs/<b>PasteList/test1.log</b>" in <b> PasteList.xml </b>
	 * 
	 * @param className test1 (for ex:)
	 * @param testCaseName PasteList (for ex:)
	 */
	public static void setLogFileName(String className, String testCaseName) {
